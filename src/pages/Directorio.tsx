...
export const Directorio: React.FC = () => {
  ...
  const getBuildInfo = () => {
    ...
    const buildDate = new Date('2025-09-16T22:50:10.812Z'); // Fecha actualizada automáticamente // Fecha actualizada automáticamente // Fecha actualizada automáticamente
